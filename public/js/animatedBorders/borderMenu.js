 ...
 * http://www.codrops.com
 */
var bordersActivated = false;
var activateBorderMenus = function() {
	...
	function init() {
		...
		trigger.addEventListener( eventtype, function( ev ) {
			...
			if( classie.has( menu, 'bt-menu-open' ) ) {
				...
				var elements = $('ul.bt-menu a').each(function(index, element) {
					element.addEventListener('click', closeClickFn);
				});
