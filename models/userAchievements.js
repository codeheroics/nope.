...
var LEET_PLUS_ONE_MINUTES = 80280000;
...
var achievements = {
  ...
  25: {
    ...
    hasEarned: function(user, nopeData, isVictory) {
...
module.exports = {
  ...
  earnedAfterVictoryOrDefeat: function(user, nopeData, isVictory) {
    return achievableByVictoryDefeat.filter(function(achievementId) {
      if (user.achievements[achievementId]) return false; // Already earned
      return achievements[achievementId].hasEarned(user, nopeData, isVictory);
    });
  },
};
